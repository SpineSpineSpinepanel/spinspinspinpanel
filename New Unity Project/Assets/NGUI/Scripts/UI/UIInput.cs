...
// ---------------------------------------------------------------
// Code Added for AndroidKeyboard
...
// ---------------------------------------------------------------
    ...
    protected virtual void Update()
    {
		...
		if(mSelectTime == Time.frameCount) 
			return;
...
// 				UpdateLabel();
    ...
    {
        //Debug.LogError("OnSelectEvent_Android");
    ...
    void Update_AndroidKeyboard(bool executeOnChange)
    {
        ...
        if (inputShouldBeHidden)
        {
            ...
            mSelectionStart = AndroidKeyboard.TouchScreenKeyboard.CursorPositionStart;
            mSelectionEnd = AndroidKeyboard.TouchScreenKeyboard.CursorPositionEnd;
        }
        else if (mCached != text)
        {
            mCached = text;
